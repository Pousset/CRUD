...
if (isset($_POST["submit"])) {
   ...
   if ($result) {
      header("Location: index.php?msg=L'utilisateur à été ajouté avec succès");
   } else {
...
<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #3B09BA73;">
      CRUD PHP CUBE3
   </nav>
   ...
   <div class="container">
      <div class="text-center mb-4">
         ...
         <p class="text-muted">Completer le formulaire pour ajouter un nouvel utilisateur</p>
      </div>
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="form-group mb-3">
               ...
               <label for="male" class="form-input-label">Homme</label>
               &nbsp;
